package demosample.nirav.com.demoproject.utils.pinview;
...
import static demosample.nirav.com.demoproject.utils.ViewUtils.convertDpToPixel;
...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mViewType = a.getInt(R.styleable.PinView_viewType, VIEW_TYPE_LINE);
...
// draw rect
    ...
    private void updateCursorHeight() {
        int delta = 2 * convertDpToPixel(2);
